...
public class Operacoes {
	...
	public static ArrayList<Output> reservaMensal() {
		...
		for (int i = 1; i <= 12; i++) {
			...
			// mes.
			// Sabemos que alguns tem 30 outros 31 e Fevereiro de 2017 tem 28, além de que,
			// eles não possuem uma forma de intercalar muito padronizada. Essa variável vai
			// nos ajudar a não reescrever código.
	...
	public static String reservaAnual() {
		...
		// Declarando e instanciando o formatador de {float}.
		DecimalFormat df = new DecimalFormat("0.00");
