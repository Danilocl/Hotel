...
public class DialogOcupacaoMedia extends JDialog {
	...
	private void buildMediaAnual() {
		JLabel labelMediaGastosOcupaÁ„o = new JLabel("MÈdia OcupaÁ„o: ");
		panel.add(labelMediaGastosOcupaÁ„o, new GBC(0, 0));
		JTextField tfMediaOcupaÁ„o = new JTextField(20);
		// Chamando o m√©todo que faz as contas para pegar o valor anual.
		tfMediaOcupaÁ„o.setText(Operacoes.mediaOcupacaoAnual());
		tfMediaOcupaÁ„o.setEditable(false);
		panel.add(tfMediaOcupaÁ„o, new GBC(1, 0).horizontal());
	...
	private void buildTable() {
		...
		// eu
		// chamo outro m√©todo.
		opTableModel.adicionaTableModel(Operacoes.mediaOcupacaoMes());
