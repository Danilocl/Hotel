...
public class DialogGastosExtras extends JDialog{
	...
	private void buildMediaAnual() {
		JLabel labelMediaGastosExtras = new JLabel("M�dia Gastos Extras: ");
		...
		tfMediaExtras.setText(Operacoes.gastosAnual());
