 ...
 *
 */
public class DialogMediaNoites extends JDialog {
	...
	private void buildMediaAnual() {
		...
		tfMediaAnual.setText(Operacoes.noitesAnual());
	...
	private void buildTable() {
		...
		// chamo outro método.
		opTableModel.adicionaTableModel(Operacoes.noitesMensal());
